 ...
 *
 * Per process file, set "caption" to the File Details text shown in secret.html:
 *
 *   "media": [
                    ...
                    },
{
        ...
        "graphics": [
            {
                ...
                "media": [
                    ...
                    {
                        "url": "secret%20portfolio%20process/graphics/berry/value.png",
                        "label": "VALUE",
                        "caption": "Graphic in B&W view."
                    },
                    {
                    ...
                    {
                        "url": "secret%20portfolio%20process/graphics/berry/ref1.jpg",
                        "label": "REF",
                        "caption": "Reference photo for strawberry form and cluster composition."
                    },
                    {
                        "url": "secret%20portfolio%20process/graphics/berry/ref2.jpg",
                        "label": "REF 2",
                        "caption": "Secondary reference for blossom shapes and color accents."
                    }
                ],
                "description": "Tileable strawberry and bloom graphic study in vivid low-poly style.",
                "tag": "Graphic Design",
                "tileGrid": {
                    "cols": 5,
                    "rows": 5,
    ...
    "menuContent": {
        ...
        "professional": {
            "title": "Professional",
            "file": "professional.txt",
            "tag": "Experience",
            "body": "Available for visual development, background painting, prop design, and concept art support.\n\nCore strengths:\n• Cinematic environment design\n• Mood-driven lighting and color scripting\n• Asset iteration from sketch through final\n• Pipeline-friendly layered deliverables\n\nPast work spans indie games, animation pre-production, and illustrated editorial projects."
        },
        "contact": {
            "title": "Contact",
            "file": "contact.txt",
...
(function sortVisdevSectionsByMediaCount() {
    ...
    if (!db) return;
    ['backgrounds', 'props', 'concepts', 'vehicles', 'motionGraphics', 'graphics'].forEach(function (section) {
