...
window.PORTFOLIO_DATA = {
    ...
    "mediaPhaseCaptions": {
        "FINAL": "Final render for {title}. {description}",
        "SKETCH": "Sketch pass — loose composition study for {title}. Exploring layout, silhouette, and narrative read before committing to detail.",
        "BLOCKOUT": "Blockout pass for {title}. Establishing major forms, depth planes, and value structure across the scene.",
        "LIGHTING": "Lighting pass for {title}. Refining mood, bounce light, and focal contrast to support the story beat."
    }
};
